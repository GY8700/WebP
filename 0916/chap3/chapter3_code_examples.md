...
이 문서는 웹프로그래밍 3장에 나오는 **예제 3-1부터 예제 3-19까지의 소스 코드 모음**입니다. 각 예제별 코드를 복사하여 깃허브(GitHub) 리포지토리에 파일별로 직접 추가하실 수 있습니다.

---

## 📂 파일 목록 및 예제 구성

- `ex3-01.html`: HTML5 문서 구조 시맨틱 태그 사용
- `ex3-02.html`: 시맨틱 태그로 구조화 연습 (모차르트)
- `ex3-03.html`: `<details>`와 `<summary>` 태그 활용
- `ex3-04.html`: 시맨틱 인라인 태그 (`<mark>`, `<time>`, `<meter>`, `<progress>`)
- `ex3-05.html`: 간단한 로그인 폼
- `ex3-06.html`: 텍스트 및 여러 줄 입력 폼 (`<textarea>`)
- `ex3-07.html`: 데이터 목록을 가진 텍스트 입력 (`<datalist>`)
- `ex3-08.html`: 다양한 버튼 종류 만들기
- `ex3-09.html`: 체크박스 만들기
- `ex3-10.html`: 라디오버튼 만들기
- `ex3-11.html`: 드롭다운 콤보박스 만들기 (`<select>`)
- `ex3-12.html`: `<label>` 태그로 로그인 폼 만들기
- `ex3-13.html`: `<label>`로 라디오버튼에 캡션 만들기
- `ex3-14.html`: 컬러 다이얼로그로 색 입력받기 (`<input type="color">`)
- `ex3-15.html`: 시간 및 날짜 정보 입력 폼 (`date`, `week`, `month`, `time`, `datetime-local`)
- `ex3-17.html`: 스핀버튼과 슬라이드바로 숫자 입력받기 (`number`, `range`)
- `ex3-18.html`: 형식을 가진 텍스트 입력 (`email`, `url`, `tel`, `search`)
- `ex3-19.html`: `<fieldset>`으로 폼 요소 그룹핑하기
